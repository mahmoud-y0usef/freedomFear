...
const DATA_BASE_NAME = 'freedom_1_database';
const DATA_BASE_USER = 'freedom_1_database';
const DATA_BASE_PASSWORLD = 'DXSqiW!qO0Mr?d78';
...
const ADMIN_EMAIL = 'support@freedom-fear.com'; // email address from which the verification emails will be send.
const GAME_NAME = 'FreedomFear';
